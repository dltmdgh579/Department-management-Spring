...
-- 개인
insert into personnel(name, date_of_birth, phone, landline, email, work_space, address, profile_image, department_type, department_id, small_group_id)
values('test1', '1997-08-26', '010-0000-0001', '032-000-0001', 'test1Email@gmail.com', '고잉메리호', '인천광역시 서구 석남동', '', 'JOSHUA', 4, 1);
insert into personnel(name, date_of_birth, phone, landline, email, work_space, address, profile_image, department_type, department_id, small_group_id)
values('test2', '1997-08-26', '010-0000-0002', '032-000-0002', 'test2Email@gmail.com', '고잉메리호', '인천광역시 서구 석남동', '', 'JOSHUA', 4, 2);
insert into personnel(name, date_of_birth, phone, landline, email, work_space, address, profile_image, department_type, department_id, small_group_id)
values('test3', '1997-08-26', '010-0000-0003', '032-000-0003', 'test3Email@gmail.com', '고잉메리호', '인천광역시 서구 석남동', '', 'JOSHUA', 4, 2);
